...
export let groupBills = [
    {
        ...
        name: "Мои счета",
        bills: getBills("411ce821-5ba7-4829-a3c9-d31f2763d26e"),
    },
    {
        id: "30d65281-6e8d-405a-8c3e-7e6dfa1cd6a1",
        userId: "a1b2c3d4-e5f6-7g8h-9i0j-k1l2m3n4o5",
        name: "Накопления",
        bills: getBills("30d65281-6e8d-405a-8c3e-7e6dfa1cd6a1"),
    },
    {
        id: "b77d652c-f5ae-4385-8099-0aa4e1f79836",
        userId: "a1b2c3d4-e5f6-7g8h-9i0j-k1l2m3n4o5",
        name: "На будущее",
        bills: getBills("b77d652c-f5ae-4385-8099-0aa4e1f79836"),
    }
]
